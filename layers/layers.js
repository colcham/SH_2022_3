...
lyr_DistributionSites_2.set('fieldImages', {'x': 'Hidden', 'y': 'Hidden', 'Site': 'TextEdit', 'Distributi': 'TextEdit', 'Site Type': 'TextEdit', 'Prepared F': 'TextEdit', 'Non Food S': 'TextEdit', 'Unhoused S': 'TextEdit', 'Geographies of Stuff - Sheet2_Unhoused': 'TextEdit', });
lyr_Boundaries_1.set('fieldLabels', {'NAME': 'header label', });
lyr_DistributionSites_2.set('fieldLabels', {'Site': 'header label', 'Distributi': 'header label', 'Site Type': 'header label', 'Prepared F': 'header label', 'Non Food S': 'header label', 'Unhoused S': 'header label', 'Geographies of Stuff - Sheet2_Unhoused': 'header label', });
